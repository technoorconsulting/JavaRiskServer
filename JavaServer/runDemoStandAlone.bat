...
set CP=%CP%;.\dist\JavaProject1.jar
...
rem "%JAVA_HOME%\bin\java" -Xdebug -Xrunjdwp:transport=dt_socket,address=8001,server=y -classpath %CP%;.\src -Dgft.url=%URL% -Dgft.login=%USER_ID% -Dgft.password=%PASSWORD% gft.api.example.ApiUsage
