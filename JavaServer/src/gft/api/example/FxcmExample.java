  ...
  implements IGenericMessageListener, IStatusMessageListener
{
   ...
   */
  public FxcmExample(String username, String password, String terminal, String file)
  {
   ...
   * @param server - url, like 'http://www.fxcorporate.com/Hosts.jsp'
   */
  public FxcmExample(String username, String password, String terminal)
  {
    // call the proper constructor
    this(username, password, terminal, null);
  }

  public FxcmExample(String[] args)
  {
    // call the proper constructor
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      FxcmExample miner = new FxcmExample("89004919", "tinyfx8150", "Real");
